...
public class Manager extends Thread {
    ...
    private void handleUpdate(Write write) {
        ...
        AttributeValueUpdate update = new AttributeValueUpdate().withAction(AttributeAction.PUT).withValue(new AttributeValue().withN(value));

        Application.getClient().updateItem(buildUpdateRequest(a, b, update));
        Application.getClient().updateItem(buildUpdateRequest(b, a, update));
    }
    ...
    private UpdateItemRequest buildUpdateRequest(String a, String b, AttributeValueUpdate update) {
        ...
        UpdateItemRequest updateItemRequest = new UpdateItemRequest().withTableName(tableName).withKey(key).withAttributeUpdates(updates)
